...
def generate(state: RAGState) -> RAGState:
    system_prompt = (
        ...
        "Transmission Company Ltd) technical manuals. "
        "If the user greets you (e.g. says hi, hello, hellwo, or greeting), respond with a friendly greeting. "
        "Otherwise, answer the user's question using ONLY the provided context. Be precise and concise. "
...
def ask(question: str) -> dict:
    ...
    greetings = {
        "hi", "hello", "hey", "greetings", "greet", "greeting", "hellwo",
        "good morning", "good afternoon", "good evening",
        "hello there", "hi there", "namaste", "hola"
    }
    if normalized in greetings:
        return {
            "answer": "Hello! I am your MSEB/MSETCL Assistant. How can I help you today?",
            "retrieved_docs": [],
        }
